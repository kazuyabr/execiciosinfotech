...
public abstract class Personagem implements Lutador {
    ...
    public boolean verificarLevelUp() {
        int experienciaParaProximoNivel = Experiencia.calcularExperienciaParaProximoNivel(this.experiencia);
    ...
    public void mostrarItem(int posicao) {
        try {
            String item = inventario.get(posicao);
            System.out.println("Item na posicao " + posicao + ": " + item);
        } catch (IndexOutOfBoundsException e) {
            System.out.println("Infelizmente a posicao acessada nao tem item " + posicao);
        }
    }
